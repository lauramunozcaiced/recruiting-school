...
@section('content')
    @auth
        <div class="{{ Auth::user()->role }} dashboard-content app__dashboard-content">
            <x-layout.title title="Clients"></x-layout.header-title>
            ...
            <button type="button" class="btn btn-primary position-create" data-toggle="modal" data-target="#createCustomer"><i
